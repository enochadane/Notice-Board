...
type RoleService struct {
	roleRepo company.RoleRepository
}

// NewRoleService  returns new RoleService
func NewRoleService(RoleRepo company.RoleRepository) company.RoleService {
...
// Role retrievs a given company role by its id
...
// UpdateRole updates a given company role
...
// DeleteRole deletes a given company role
...
// StoreRole stores a given company role
