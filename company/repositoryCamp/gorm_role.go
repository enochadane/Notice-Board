...
func NewRoleGormRepo(db *gorm.DB) company.RoleRepository {
	return &RoleGormRepo{conn: db}
}

// Roles returns all company roles stored in the database
...
// UpdateRole updates a given company role in the database
...
// DeleteRole deletes a given company role from the database
...
// StoreRole stores a given company role in the database
